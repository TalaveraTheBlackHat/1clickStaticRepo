...
$.ajax({
  ...
  success: function(productos) {
    ...
    // PRECIO ANTIGUO
    // <div class="card__precio__antes">`+productos[1][i].precio_unitario+"$"+`</div>
  var cant=productos[0].length;
  ...
  cantProductos=localStorage.getItem("cantProductos");
    ...
    if(cantProductos<23){ 
      for (i = 0; i < cantProductos; i++) {
        ...
        <div class="card__img"><a onclick="ficha('`+enviar+`')"><img src="`+productos[1][i].img_producto+`" alt=""></a></div>
        <div class="card__title" style="font-size: .7rem;">`+productos[1][i].descripcion+`</div>
